...
uses
  SysUtils, StrUtils, Graphics, Classes, Registry, sqldb, db;

const
  pVersion = '10/02/2017';

  RegIniFileName = 'demo';
  SMSFileName = 'demo_sms_data';
...
var
  ConfigFileName: String = 'demo.cfg';
  fbPort: integer = 3050;
...
begin
  ...
  try
    Q.Database := dm.fDatabase;
    Q.Transaction := dm.fTransaction;
